...
namespace Kardashit
{
    public class NeuralNetwork
    {
        ...
        public void Train(double[][] trainData, int maxEprochs, double learnRate, double momentum, double weightDecay, double minMse)
        {
            ...
            {
                if (MeanSquaredError(trainData) < minMse)
                    break;
